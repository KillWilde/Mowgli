...
@interface PersonalVC () <UIScrollViewDelegate>
 
...
- (void)viewDidLoad {
    ...
         
    UIScrollView *scroll = [[UIScrollView alloc] initWithFrame:CGRectMake(0, 0, 300, 400)];
    scroll.contentSize = CGSizeMake(300, 1200);
    
    scroll.backgroundColor = [UIColor blackColor];
    scroll.delegate = self;
    [self.view addSubview:scroll];     CYThread *tmpThread = [[CYThread alloc] initWithTarget:self selector:@selector(subThreadTodo) object:nil];
